...
O protótipo da aplicação apresenta uma estrutura bem subdividida, contendo o frontend e o backend estruturados pelos seus frameworks, pode ser escalável visando uma aplicação para o mercado FALTA MELHORAR, de acordo com os parâmetros de \citeonline{ALGUEM}.
