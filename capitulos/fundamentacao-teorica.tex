...
% A programação reativa, de acordo com \citeonline{GUEDES}, é um modelo ou paradigma de programação orientado ao fluxo de dados e da propagação de estados. Os fluxos de dados podem ser assíncronos, sendo operações independentes uma das outras, fazendo com que os estados do objeto sejam alterados.
